/*
* @Author: UsingLove
* @Date:   2017-10-24 13:00:56
* @Last Modified by:   UsingLove
* @Last Modified time: 2017-10-24 15:53:17
*/
...
var addressModal = {
    ...
    getSelectOption : function(optionArray){
        ...
        for(var i = 0, length = optionArray.length; i < length; i++) {  // 直接缓存在length中，不用每次都去optionArray.length取，提高效率
