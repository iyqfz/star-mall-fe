/*
* @Author: UsingLove
* @Date:   2017-10-24 13:15:49
* @Last Modified by:   UsingLove
* @Last Modified time: 2017-10-24 14:00:58
*/
...
var _cities = {
    cityInfo : {
        ...
        '江西省':['南昌','九江','景德镇','鹰潭','新余','萍乡','赣州','上饶','抚州','宜春','吉安'],'山东省':['济南','聊城','德州','东营','淄博','潍坊','烟台','威海','青岛','日照','临沂','枣庄','济宁','泰安','莱芜','滨州','菏泽'],
    ...
    getProvinces : function(){
        var provinces = [];
        for(var item in this.cityInfo) {    // for in 可以循环对象
            provinces.push(item);
        }
        return provinces;
    },
